...
public class AESOperator {
     ...
     */
    private String sKey = "toooenqwertyuiopa";
    private String ivParameter = "12I9OPQjaC5FlFIl";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String DeString = AESOperator.getInstance().decrypt("w1ujcZvRwYUsYxyQlzph6g==");
